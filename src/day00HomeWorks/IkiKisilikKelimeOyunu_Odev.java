...
public class IkiKisilikKelimeOyunu_Odev {
	...
	public static void main(String[] args) {
	     ...
	     *
	     * 2.Adým- 1.oyuncu kelimeyi girince 2.oyuncuya kelimeyi kabul edip etmedigini sorun.
	     ...
	     *
	     * 3.Adým- 2. oyuncuya oyuna devam etmek isteyip istemedigini sorun
    ...
    public static void oyuncuDegistir() {//bu methoda oyuncu nosu deðiþtiriliyor
        if (oyuncu == 1) {//oyuncu nosu 1 ise 2 olarak ata
            oyuncu = 2;
        } else oyuncu = 1;//oyuncu nosu 1 deðilse 1 olarak ata
    }
    ...
    public static void onaySor() {
      ...
      int kabul = sc.nextInt();
        if (kabul == 1) {// 1 tercihi girilen kelimeyi kabul ediyor demektir
            ...
            else puan1 += kelime.length();//puaný 1. oyuncuya kelime harf saysý kadar ekledik.
            oyunaDevamEdecekMi();
