...
public class C02_StringManipulation02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Lutfen kart numaranýzý giriniz.");
		String kkNo=scan.nextLine();
		
		
		String isimDuzenlenmis = isim.substring(0, 1).toUpperCase() + //ilk harfi buyuk olarak verir
								isim.substring(1).replaceAll("\\w","*"); // ilk harften sonraki tum harfleri yildiza cevirir
				 					
		
		String soyisimDuzenlenmis= soyisim.substring(0,1).toUpperCase()+soyisim.substring(1).replaceAll("\\S","*");
