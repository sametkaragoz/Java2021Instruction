...
public class C01 {
	...
	public static void main(String[] args) {
		// System.out.println(sayi); // sayi instance bir variable oldugu icin direk
		// main method'dan kullanilamaz
		...
		// sagdaki C01( ) : class ismi ile ayni ama yaninda ( ) oldugu icin
		// CONSTRUCTOR'dir
		...
		obj1.sayi = 44;
		// System.out.println(sayi); obje urettik diye instance'a direk ulasamayiz,
		// mutlaka obje kullanmaliyiz
