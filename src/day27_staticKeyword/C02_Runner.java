...
public class C02_Runner {
	...
	// bu main method'da static access ile ilgili
	...
	public static void main(String[] args) {
		...
		// ilk once C01 deki variable'larin instance mi yoksa static mi olduguna bakmam
		// gerekir
		// ornegin sayi ve str instance variable'lardir, dolayisiyla onlara obje
		// uzerinden ulasabilirim
		...
		obj3.sayi2 = 27; // CTE vermez...
							...
							// Cunku Java daha kisa ve emin bir yol varken nicin obje uzerinden ulastin diye
							// sikayet eder
