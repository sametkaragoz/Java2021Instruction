...
public class C03_StaticKeyword {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Static variable ve method'lara ulasmak istedigimizde classIsmi.methodIsmi
		 * yazmamiz yeterli olur.
		 * 
		 * Ornegin array'lerde kullandigimiz Arrays class'i altindaki toString( )
		 * method'u static olarak java developerlari tarafindan hazirlanmis oldugu icin
		 * Arrays.toString( ) yazarak method'u rahatlikla kullanabiliyoruz
		 * 
		 * Ancak variable'lari static yapmak biraz riskli Mesela bir okul uygulamasinda
		 * okul ismini static variable olarak olusturursak avantaj olarak heryerden
		 * rahatlikla okul ismine ulasabiliriz
		 * 
		...
		staticMethod();
		// staticOlmayanMethod(); // main method static oldugu icin static olmayan
		// method'u cagiramayiz
