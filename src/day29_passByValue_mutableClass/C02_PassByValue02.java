...
public class C02_PassByValue02 {
	...
	public static void main(String[] args) {
		 ...
		 * ekleyelim. Iki method olusturup list ve array’i degistirmeyi deneyelim 1.
		 * Method’da array’e yeni bir array assign edelim ve yeni halini yazdiralim 2.
		 * Method’da list’e yeni bir list assign edelim ve yeni halini yazdiralim
		 * 
		...
		arrayiDegistir(arr);
		System.out.println("arrayiDegistir method'u calistiktan sonra main method icinde arr " + Arrays.toString(arr)); // [10,
																														// 11,
																														// 12]
