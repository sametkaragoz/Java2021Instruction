...
public class C08_CheckMemory {
	...
	public static void main(String[] args) {
		...
		System.out.println("Total Memory:" + rt.totalMemory());            // makinenin hafizasi
		System.out.println("Loop tan once Free Memory:" + rt.freeMemory());// makinedeki free alan
