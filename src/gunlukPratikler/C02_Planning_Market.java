...
public class C02_Planning_Market {

	
	/*
    1) Ürünler (String) ve ürün fiyatlari(double) için ayri ayri list oluşturulmali.
    list ler class levelde omali cunku: main metod harici diger metodlarda kullanılacak
    Listenen urunleri bir method() ile kullanıcıya gösterilmeli  yazdiran bir method olmali
